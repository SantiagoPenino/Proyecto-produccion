...
router.post('/caja/orden/exonerar/revertir', verifyToken, revertirExoneracionOrden);
router.post('/caja/orden/estado',      verifyToken, cambiarEstadoOrden);
router.get('/mostrador/estado', verifyToken, getEstadoOrden);
