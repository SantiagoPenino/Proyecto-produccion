...
// Todo este controller cuelga de /caja, que en contabilidadRoutes pasa por
// `soloInternoConRol()`: acá abajo req.user siempre es un usuario INTERNO. Por eso
// `req.user.id` va sin fallback — el viejo `|| 70` apuntaba a un IdUsuario que no
// existe en dbo.Usuarios, así que cuando se disparaba dejaba el movimiento sin
// operador y la grilla lo mostraba como "Sistema" en vez de fallar a la vista.
