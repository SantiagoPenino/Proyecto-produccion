  ...
  const areaConfig = {
    ...
    renderRowCells: (order, index, styles) => [
      ...
      React.createElement('div', { 
        ...
        React.createElement('div', { className: styles.timeBadge }, '5h')
      ),
      ...
      React.createElement('div', { 
        ...
        React.createElement('span', { className: styles.modeText }, 'Textil')
      ),
      ...
      React.createElement('div', { 
        ...
        React.createElement('span', { className: styles.quantity }, '20m')
      ),
      ...
      React.createElement('div', { 
        ...
        React.createElement('span', { className: styles.statusBadge }, order.status || 'Imprimiendo')
      ),
      ...
      React.createElement('div', { 
        ...
        React.createElement('span', { className: styles.machine }, 'Directa-320')
      ),
    ...
    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', backgroundColor: '#f8fafc' }}>
      ...
      <div style={headerStyles.headerContainer}>
        <div style={headerStyles.headerLeft}>
          ...
          <div>
            <h2 style={headerStyles.areaTitle}>Directa 3.20</h2>
          ...
          >
            ...
            <option value="DIRECTA-01">Directa-320-01</option>
            <option value="DIRECTA-02">Directa-320-02</option>
          </select>
        </div>
          ...
          <div style={{ flex: 1, overflow: 'auto', padding: '0.5rem' }}>
            <div style={{ 
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.75rem' }}>
                <span style={{ fontWeight: 'bold', color: '#0891b2' }}>Rollo D-101</span>
