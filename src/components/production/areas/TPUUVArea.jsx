...
const TPUUVArea = ({ 
  ...
  const areaConfig = {
    name: 'TPU UV',
    gridTemplate: '40px 40px 60px 80px 100px 220px 150px 80px 60px 70px 90px 120px 50px',
    headers: ['', 'Pos', 'Orden', 'Ingreso', 'Matriz', 'Cliente', 'Trabajo', 'Nota', 'Arch.', 'Unid.', 'Estado', 'Máquina', 'Chat'],
    ...
    renderRowCells: (order, index, styles) => [
      ...
      React.createElement('div', { 
        ...
        React.createElement('span', { className: styles.matrixBadge }, 'TPU-001')
      ),
      ...
      React.createElement('div', { 
        ...
        React.createElement('span', { className: styles.machine }, 'UV Flatbed')
      ),
    ...
    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', backgroundColor: '#f8fafc' }}>
      ...
      <div style={headerStyles.headerContainer}>
        <div style={headerStyles.headerLeft}>
          ...
          <div>
            <h2 style={headerStyles.areaTitle}>TPU UV</h2>
          ...
          >
            ...
            <option value="UV-HYBRID">UV Híbrida</option>
          </select>
        </div>
          ...
          <div style={{ flex: 1, overflow: 'auto', padding: '0.5rem' }}>
            <div style={{ 
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.75rem' }}>
                <span style={{ fontWeight: 'bold', color: '#15803d' }}>Matriz TPU-001</span>
