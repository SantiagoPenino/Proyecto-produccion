...
.logo{width:40mm;height:auto;display:block}
...
function buildPrintHtml(tab, doc, vendedor, totales) {
    const logo = `<img class="logo" src="${window.location.origin}/assets/images/logo/logo.webp" alt="user">`;
                ...
                <div className="pp-stage">
                    <div className="pp-sheet">
                        <header className="pp-hdr">
                            <img className="pp-logo" src="/assets/images/logo/logo.webp" alt="user" />
